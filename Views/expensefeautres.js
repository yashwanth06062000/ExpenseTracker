...
expenseform.addEventListener("click", (e) => {
  ...
  if (e.target.className == "submit") {
    ...
    axios
      .post("http://52.66.158.127:3000/addexpense", expensedetails, {
        headers: { Authorization: token },
      })
      .then(() => {
        expensecontainer.innerHTML = "";
        axios
          .get("http://52.66.158.127:3000/getexpenses", {
            headers: { Authorization: token },
          })
          .then((expenses) => {
...
window.addEventListener("DOMContentLoaded", (e) => {
  ...
  axios
    ...
    .get("http://52.66.158.127:3000/getexpenses/?page=1", {
      headers: { Authorization: token },
    })
    .then((expenses) => {
...
expensecontainer.addEventListener("click", (e) => {
  if (e.target.className == "dltexp") {
    ...
    axios
      .post("http://52.66.158.127:3000/deleteexpense", dltexpense, {
        headers: { Authorization: token },
      })
      .then((e) => {
    ...
    .then((response) => {
      var options = {
        ...
        handler: function (response) {
          ...
          axios
            .post(
              "http://52.66.158.127:3000/updatetransactionstatus",
              {
...
async function is__premium() {
  ...
  const token = localStorage.getItem("token");
  await axios
    .post("http://52.66.158.127:3000/is_premium", obj, {
      headers: { Authorization: token },
    })
    .then((res) => {
      ...
      if (res.data.ispremium) {
        ...
        axios
          .get("http://52.66.158.127:3000/leaderboard", {
            headers: { Authorization: token },
          })
          .then((users) => {
...
pageevent.addEventListener("click", (e) => {
  ...
  if (e.target.className == "page") {
    ...
    expensecontainer.innerHTML = "";
    axios
      .get(`http://52.66.158.127:3000/getexpenses/?page=${UserId}`, {
        headers: { Authorization: token },
      })
      .then((expenses) => {
        console.log(expenses.data.obj);
